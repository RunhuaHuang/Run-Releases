...
> 以下链接随每次发版自动更新为最新版本（当前 v0.13.25）。
...
👉 [`Run-0.13.25-arm64.dmg`](https://github.com/RunhuaHuang/Run-Releases/releases/download/v0.13.25/Run-0.13.25-arm64.dmg)
...
👉 [`Run-Windows-OneClick-v0.13.25.zip`](https://github.com/RunhuaHuang/Run-Releases/releases/download/v0.13.25/Run-Windows-OneClick-v0.13.25.zip)
